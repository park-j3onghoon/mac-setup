...
`~/.claude/lib/answer-style.md`와 `~/.claude/explain-style.md`를 Read한다. 후자는 **ELI5**(비유 → 정의 → 실제 맥락 예시), why-first, 예상 후속 질문 흡수, 약어 풀네임, 혼동 쌍은 표로. 테이블·필드를 다루는 문서면 `~/.claude/lib/data-notation.md` 가 있으면 Read해 그 표기를 따른다.

...
`~/.claude/explain-style.md`를 Read한다 — **ELI5**(비유 → 정의 → 실제 맥락 예시), why-first, 예상 후속 질문 흡수, 약어 풀네임, 혼동 쌍은 표로. 테이블·필드를 다루는 문서면 작업 대상 프로젝트의 `CLAUDE.md`에 있는 데이터 위치 표기 규칙도 Read해 그대로 적용한다.

...
- 테스트 코드 (tests/)
- 설정/기타 파일
- **제외**: .env, credentials, 임시 파일, .claude/rw-plan.md, .claude/rw-checklist.md
...
- .env, 시크릿, .claude/rw-plan.md, .claude/rw-checklist.md 등 민감/임시 파일 미포함
